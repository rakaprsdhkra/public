...
/**
 * Classes and menus for itop-request-mgmt-itil (version 2.7.6)
 *
...
class UserRequest extends Ticket
{
	public static function Init()
	{
		...
		MetaModel::Init_AddAttribute(new AttributeEnum("status", array("allowed_values"=>new ValueSetEnum("new,waiting_for_approval,approved,rejected,assigned,pending,escalated_tto,escalated_ttr,resolved,closed,dispatched,redispatched"), "display_style"=>'list', "sql"=>'status', "default_value"=>'new', "is_null_allowed"=>false, "depends_on"=>array(), "always_load_in_tables"=>true)));
