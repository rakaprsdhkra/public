...
EOF;
			...
			if (!empty($sNorthPane))
			{
				$sNorthPane = '<div id="top-pane" class="ui-layout-north" style="height: 180px;">'.$sNorthPane.'</div>';
			}
			...
			$sHtml .= ' <div class="ui-layout-north" style="height: 180px;">';
			$sHtml .= ' <div id="header-logo">';
			$sHtml .= ' <div id="top-left"></div><div id="logo"><img src="'.$sDisplayIcon.'" title="'
